  ...
  1. Open the *Student* class (`src/com/generation/model/Student.java`) and implement the following methods:
   ...
   ```java
    public void enrollToCourse( Course course )
    {
        ...
        // Check if the user is already enrolled or the course is full
        if (isEnrolledInCourse(course) || course.isFull()) {
            return;
        }

        // Add the user to the course's enrollment list
        course.enrollStudent(this); // Assuming 'this' refers to the current user
    ...
    {
        //TODO implement this method
        // Query the database or configuration to check if the course is approved
        return courseApprovalRepository.isCourseApproved(courseCode);       
        //return false;
    }
    @Override
    ...
    {
        //TODO implement this method
        // Query the database or configuration to get the list of approved courses
        return courseApprovalRepository.getApprovedCoursesForUser(this); 
        //return null;
    }
   ```
